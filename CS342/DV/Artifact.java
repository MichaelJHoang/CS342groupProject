//name: Dilip Vemuri
//ACCC: dvemuri3
//Artifact class: This class represents items in the game world. They can be in the players inventory (game class) or found in the world ( place class)
//package hw1cs342;
...
public class Artifact {
	...
	public Artifact( Scanner s){		
		...
		if( locationID < 0) {
			...
			while( p.getPlaceID() == 0 || p.getPlaceID() == 1) {
