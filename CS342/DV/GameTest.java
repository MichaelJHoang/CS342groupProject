//name: Dilip Vemuri
//ACCC: dvemuri3
//GameTest class CHECKS For command line arguments, opens the file and creates the game class
//package hw1cs342;
...
public abstract class GameTest {
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		System.out.println("Name: Dilip Vemuri");
		System.out.println("NetID: dvemuri3");
		System.out.println("Assignment: HW3 CS342");
		File test = null;
